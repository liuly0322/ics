$(document).ready(function () {
  ...
  (function () {
    ...
    var createLabelRow = function (text, address, exists) {
      ...
      $name.on("input", function () {
        ...
        var conflict =
          newName in lc3.labelToAddress &&
          newName !== linkage.previous.labelName;
        var invalid =
          newName.match(/[^A-Za-z0-9_]/) ||
      ...
      $address.on("input", function () {
        ...
        var conflict =
          num !== linkage.previous.labelAddress && num in lc3.addressToLabel;
  ...
  (function () {
    ...
    for (var i = 0; i < lc3.r.length; i++) {
      ...
      var $row = $("<div>").addClass("col-xs-6 col-sm-3");
      var $name = $("<span>").addClass("register-name").text(name);
      var $value = $("<span>")
    ...
    for (var i = 0; i < lc3.specialRegisters.length; i++) {
      ...
      var $row = $("<div>").addClass("col-xs-12 col-sm-3");
      var $name = $("<span>").addClass("register-name").text(name);
      var $value = $("<span>")
    ...
    var $row = $("<div>").addClass("col-xs-12 col-sm-3");
    var $name = $("<span>").addClass("register-name").text("CC");
    var $value = $("<span>")
  ...
  (function () {
    ...
    for (var i = 0; i < memoryRows.length; i++) {
      ...
      $bp = createDropdownItem("Set breakpoint here")
        .click(function () {
      ...
      $row.append(
        createCell("memory-address hex-value").addClass("shrink-to-fit")
      );
  ...
  (function () {
    ...
    $(".hex-value")
      .not(".hex-no-tooltip")
      .tooltip({ title: hexValueTooltipTitle });
  })();
      ...
      drop: function (e) {
        ...
        for (var i = 0; i < files.length; i++) {
          ...
          if (invalid) {
            ...
            $invalid.slideDown();
            $invalid
              .find("#warning-file-noun")
              .text($invalidList.find("li").length === 1 ? "file" : "files");
          } else {
            var $li = $("<li>")
              .append($("<strong>").text(filename || ""))
            ...
            $success
              .find("#success-file-noun")
              .text(successOne ? "file" : "files");
